                    ...
                    <table width="480" border="0" cellspacing="0" cellpadding="0" align="center">
                      ...
                      <tr>
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
								<h2 style="font-size: 20px;"><?=$name?> you now have access to the map!</h2>
                              <br>
                              <p>
							  The following link is private and it is against the rules to share it with players:<br>
							 <a href="http://huitaplus.com/<?=$map_link?>" class="link1">Private link to the worldmap</a></b>
							  </p>
                            </div>
                          </div>
                        </td>
              ...
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td width='150'>
                    <div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
						  <img src="<?=base_url("assets/map.png")?>" alt="side image" width='142' height='142' data-default="placeholder" data-max-width="150">
                      </div>
                    </div>
                  </td>
                  <td width='20'></td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              ...
                              <br>
							  <p>
							  * Include points of interests for each structures created by players.<br>
							  * Online players position and actions are also displayed.
							  </p>
                            </div>
                          </div>
                        </td>
