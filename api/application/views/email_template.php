                        ...
                        <td valign="middle" style='vertical-align: middle;'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;font-weight: light; color:#555555;font-size:26;line-height: 39px;font-family: Helvetica Neue;'>
                              <h1 class='big'><a href="http://huitaplus.com" style='color:#444444'>Huitaplus</a></h1>
                            </div>
                          </div>
                        </td>
                        <td width='10'></td>
                        <td valign="middle" style='vertical-align: middle;' width='150'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: right;'>
								<a href="<?=site_url("emails/original")?>" class='link1' >Open in your browser</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              ...
                              <br><br>
                              <a href="#" class='link2' style='color:#ffffff'>Call to action</a>
                              <br>
                            </div>
                          </div>
                        </td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: center;'>
                              ...
                              <br><br>
                              <a href="#" class='link3' style='color:#555555;'>Call to action</a>
                              <br>
                            </div>
                          </div>
                        </td>
              ...
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td width='150'>
                    <div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
						  <img src="<?=base_url("assets/side.png")?>" alt="side image" width='142' height='142' data-default="placeholder" data-max-width="150">
                      </div>
                    </div>
                  </td>
                  <td width='20'></td>
                        ...
                        <td>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class='contentEditable' style='text-align: left;'>
                              ...
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Has been the industry's standard dummy text ever since the 1500s.</p>
                              <br>
                              <a href="#" class='link4' style='color:#27A1E5;' >read more</a>
                            </div>
                          </div>
                        </td>
                      </tr>
              ...
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  ...
                  <td width='150'>
                    <div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
						  <img src="<?=base_url("assets/side2.png")?>" alt="side image" width='142' height='142' data-default="placeholder" data-max-width="150">
                      </div>
                    </div>
                  </td>
                </tr>
              ...
              <table width="580" border="0" cellspacing="0" cellpadding="0" align="center">
                ...
                <tr>
                  <td width='150'>
                    <div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable'>
						  <img src="<?=base_url("assets/side3.png")?>" alt="side image" width='142' height='142' data-default="placeholder" data-max-width="150">
                      </div>
                    </div>
                  </td>
                  <td width='20'></td>
